...
class AddEditJobPage extends StatefulWidget {
  const AddEditJobPage({Key key, @required this.database, this.job})
      : super(key: key);
  ...
  @override
  _AddEditJobPageState createState() => _AddEditJobPageState();
}
      ...
      try {
        ...
        if (allNames.contains(_name)) {
          showAlertDialog(context,
              ...
              content: 'Please use different job name',
